...
/// <summary>
/// Summary description for SagePayConfiguration
/// </summary>
public class SagePayConfiguration : ConfigurationSection
{
    ...
    public SagePayConfigurationCollection Settings
    {
        get
        {
            return (SagePayConfigurationCollection)base[""];
        }
    }
}
...
public class SagePayConfigurationCollection : ConfigurationElementCollection
{
    ...
    public SagePayConfigurationElement this[int idx]
    {
        get
        {
            return (SagePayConfigurationElement)BaseGet(idx);
        }
    }
}
...
public static class SagePaySettings
{
  ...
  public static string ReferrerID
   ...
   public static string FormPaymentUrl
    ...
    {
        SagePayConfiguration sagePayConfiguration = (SagePayConfiguration)ConfigurationManager.GetSection("SagePayConfiguration");

        foreach (SagePayConfigurationElement element in sagePayConfiguration.Settings)
        {
            if (element.Key == key)
